...
if ("undefined" == typeof $) throw new Error("template requires jQuery");
function w3_open() {
...
!(function (t) {
  ...
  (p.prototype.activate = function () {
    ...
    (p.prototype.fix = function () {
      ...
      if (t("body").hasClass(h)) t(i).css("min-height", d - e);
        ...
        var f;
        d >= u
          ? (t(i).css("min-height", d - n), (f = d - n))
          : (t(i).css("min-height", u), (f = u));
        var p = t(c);
    ...
    (m.prototype.init = function () {
      ...
      (m.prototype.toggle = function () {
        var e = t(window).width(),
          n = !t("body").hasClass(d);
        e <= this.options.collapseScreenSize && (n = t("body").hasClass(u)),
          n ? this.close() : this.open();
      }),
      (m.prototype.open = function () {
        t(window).width() > this.options.collapseScreenSize
          ? t("body").removeClass(d).trigger(t.Event(f))
          : t("body").addClass(u).trigger(t.Event(f));
      }),
      (m.prototype.close = function () {
        t(window).width() > this.options.collapseScreenSize
          ? t("body").addClass(d).trigger(t.Event(p))
          : t("body")
              .removeClass(u + " " + d)
              .trigger(t.Event(p));
      }),
  ...
  (function (t) {
    ...
    var e = "Masteradmin.tree",
      ...
      h = function (e, n) {
        (this.element = e),
          (this.options = n),
          t(this.element).addClass(c),
          t(o + r, this.element).addClass(l),
    ...
    (h.prototype.toggle = function (t, e) {
      ...
      s.is(o) &&
        ((this.options.followLink && "#" != t.attr("href")) ||
          e.preventDefault(),
        a ? this.collapse(n, s) : this.expand(n, s));
    }),
  ...
  (function (t) {
    ...
    (h.prototype.init = function () {
      t(this.element).is(i) || t(this).on("click", this.toggle),
        this.fix(),
        t(window).resize(
          function () {
            this.fix();
      ...
      (h.prototype.expand = function () {
        this.options.slide ? t(o).addClass(c) : t("body").addClass(c),
          t(this.element).trigger(t.Event(u));
      }),
      ...
      (h.prototype._fixForBoxed = function (e) {
        e.css({ position: "absolute", height: t(r).height() });
      });
    var p = t.fn.controlSidebar;
    (t.fn.controlSidebar = f),
      (t.fn.controlSidebar.Constructor = h),
  ...
  (function (t) {
    ...
    var e = "Masteradmin.todolist",
      n = { iCheck: !1, onCheck: function () {}, onUnCheck: function () {} },
    ...
    (s.prototype.toggle = function (t) {
      t.parents(o.li).first().toggleClass(i),
  ...
  (function (t) {
    ...
    (t.fn.directChat = a),
      ...
      t(".inner-content-div").slimScroll({ height: "200" }),
      t(".sm-scrol").slimScroll({ height: "250" }),
      t(".direct-chat-messages").slimScroll({ height: "420" }),
      t(".chat-box-one").slimScroll({ height: "550" }),
      t(".chat-box-one2").slimScroll({ height: "580" }),
      t(".chat-box-one-side").slimScroll({ height: "650" }),
      t(".chat-box-one-side2").slimScroll({ height: "500" }),
      t(".chat-box-one-side3").slimScroll({ height: "685" }),
      t(".notification-side").slimScroll({ height: "325" }),
      t(".suggestions-side").slimScroll({ height: "300" }),
      t(".events-side").slimScroll({ height: "265" }),
      t(".pat-div").slimScroll({ height: "204" }),
      t(".demo-panel-bx").slimScroll({ height: "auto" }),
      t(".search-box a, .search-box .app-search .srh-btn").on(
        "click",
        function () {
      ...
      t(document).on("click", ".box-btn-close", function () {
        t(this)
          ...
          .fadeOut(600, function () {
            1 == t(this).parent().children().length
      ...
      t(".open-left-block").on("click", function () {
        t(".left-block").toggleClass("open-panel"),
          t(".open-left-block").toggleClass("mdi-menu");
      }),
      ...
      t(document).on("change", '.file-group [type="file"]', function () {
        for (var e = t(this)[0], n = e.files.length, o = "", i = 0; i < n; ++i)
          o += e.files.item(i).name + ", ";
      ...
      t(".custom-file-control:not([data-input-value])").attr(
        "data-input-value",
        "Choose file..."
      ),
      t(".todo-list").todoList({
        onCheck: function () {
  ...
  (function (t) {
    ...
    t(
      ...
      .parent()
      .addClass("active"),
      t(".sidebar-menu li.active").parents("li").addClass("active");
  })($),
  (function (t) {
    "use strict";
    t('.sm li a[href="' + window.location.pathname.split("/").pop() + '"]')
      .parent()
      .addClass("current"),
      t(".sm li.current").parents("li").addClass("current");
  })($),
  $(function () {
    "use strict";
    feather.replace();
  ...
  (function (t) {
    ...
    var i = {
        ...
        show: function (t, e) {
          ...
          "touches" in t &&
            ((h = t.touches[0].pageY - u.top),
            (f = t.touches[0].pageX - u.left)),
            s.setAttribute("data-hold", Date.now()),
            s.setAttribute("data-scale", p),
            s.setAttribute("data-x", f),
            s.setAttribute("data-y", h);
          var m = { top: h + "px", left: f + "px" };
          (s.className = s.className + " waves-notransition"),
            s.setAttribute("style", o(m)),
            (s.className = s.className.replace("waves-notransition", "")),
            (m["-webkit-transform"] = p),
            (m["-moz-transform"] = p),
            (m["-ms-transform"] = p),
            (m["-o-transform"] = p),
            (m.transform = p),
            (m.opacity = "1"),
            (m["-webkit-transition-duration"] = i.duration + "ms"),
            (m["-moz-transition-duration"] = i.duration + "ms"),
            (m["-o-transition-duration"] = i.duration + "ms"),
            (m["transition-duration"] = i.duration + "ms"),
        ...
        allowEvent: function (t) {
          ...
          return (
            "touchstart" === t.type
              ...
              : "mousedown" === t.type && s.touches > 0 && (e = !1),
            e
          );
        },
        touchup: function (t) {
    ...
    function a(e) {
      ...
      null !== n &&
        (i.show(e, n),
        "ontouchstart" in t &&
          (n.addEventListener("touchend", i.hide, !1),
          n.addEventListener("touchcancel", i.hide, !1)),
        n.addEventListener("mouseup", i.hide, !1),
        n.addEventListener("mouseleave", i.hide, !1),
        n.addEventListener("dragend", i.hide, !1));
    }
    (e.displayEffect = function (e) {
      "duration" in (e = e || {}) && (i.duration = e.duration),
        i.wrapInput(n(".waves-effect")),
        "ontouchstart" in t &&
